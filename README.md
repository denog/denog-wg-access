...
This guide is edited by the DENOG Working Group (WG) Access. You don't need to be a member of the working group to contribute to the project.
...
For real-time discussions, support, and community interaction, join our [Matrix channel](https://matrix.to/#/%23denog-wg-access:matrix.org). Everyone interested is welcome to participate!

The DENOG Working Group (WG) Access mailing list can be joined at [Google Groups](https://groups.google.com/a/denog.de/g/denog-wg-access).
